defmodule Gamepedia.Migrations.V20260523000004CreateGameGenre do
  use Ecto.Migration

  def change do
    create table(:gamepedia_game_genre, primary_key: false) do
    ...
    create index(:gamepedia_game_genre, [:genre_id])
  end
end
